...
func (c *secretDiscoveryServiceClient) DeltaSecrets(ctx context.Context, opts ...grpc.CallOption) (SecretDiscoveryService_DeltaSecretsClient, error) {
	stream, err := c.cc.NewStream(ctx, &SecretDiscoveryService_ServiceDesc.Streams[0], "/envoy.service.secret.v3.SecretDiscoveryService/DeltaSecrets", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *secretDiscoveryServiceClient) StreamSecrets(ctx context.Context, opts ...grpc.CallOption) (SecretDiscoveryService_StreamSecretsClient, error) {
	stream, err := c.cc.NewStream(ctx, &SecretDiscoveryService_ServiceDesc.Streams[1], "/envoy.service.secret.v3.SecretDiscoveryService/StreamSecrets", opts...)
	if err != nil {
		return nil, err
	}

...
func (c *rateLimitQuotaServiceClient) StreamRateLimitQuotas(ctx context.Context, opts ...grpc.CallOption) (RateLimitQuotaService_StreamRateLimitQuotasClient, error) {
	stream, err := c.cc.NewStream(ctx, &RateLimitQuotaService_ServiceDesc.Streams[0], "/envoy.service.rate_limit_quota.v3.RateLimitQuotaService/StreamRateLimitQuotas", opts...)
	if err != nil {
		return nil, err
	}

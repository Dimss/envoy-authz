...
func (c *extensionConfigDiscoveryServiceClient) StreamExtensionConfigs(ctx context.Context, opts ...grpc.CallOption) (ExtensionConfigDiscoveryService_StreamExtensionConfigsClient, error) {
	stream, err := c.cc.NewStream(ctx, &ExtensionConfigDiscoveryService_ServiceDesc.Streams[0], "/envoy.service.extension.v3.ExtensionConfigDiscoveryService/StreamExtensionConfigs", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *extensionConfigDiscoveryServiceClient) DeltaExtensionConfigs(ctx context.Context, opts ...grpc.CallOption) (ExtensionConfigDiscoveryService_DeltaExtensionConfigsClient, error) {
	stream, err := c.cc.NewStream(ctx, &ExtensionConfigDiscoveryService_ServiceDesc.Streams[1], "/envoy.service.extension.v3.ExtensionConfigDiscoveryService/DeltaExtensionConfigs", opts...)
	if err != nil {
		return nil, err
	}
